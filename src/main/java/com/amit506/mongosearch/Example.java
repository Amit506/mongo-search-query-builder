...
public static class Product {
    ...
    public static void main(String[] args) {
        ...
        SearchCriteria q1 = SearchCriteria.builder()
                .fieldName("name")
                .queryType(QueryType.EQUAL_TO)
                .value("Laptop")
                .build();

        SearchCriteria q2 = SearchCriteria.builder()
                .fieldName("price")
                .queryType(QueryType.LESS_THAN)
                .value(1200)
                .build();

        SearchCriteria q3 = SearchCriteria.builder()
                .fieldName("rating")
                .queryType(QueryType.GREATER_THAN_OR_EQUAL_TO)
                .value(4)
                .build();

        SearchCriteria q4 = SearchCriteria.builder()
                .fieldName("available")
                .queryType(QueryType.EQUAL_TO)
                .value(true)
                .build();
        ...
        List<SearchToken> tokens = new QueryBuilder()
                .first(q1)
                .and(q2)
                .or(q3)
                .and(q4)
        ...
        System.out.println("Tokens: " + MongoSearchQueryBuilder.stringifyTokens(tokens));

        // Example FieldTree (replace with your actual FieldTree)
        FieldTree fieldTree = new TreeBuilder().buildTree(Product.class);

        // Build MongoDB Atlas Search Document
        MongoSearchQueryBuilder.Builder builder = new MongoSearchQueryBuilder.Builder(fieldTree, "default", tokens);
